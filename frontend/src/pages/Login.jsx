...
export default function Login() {
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-70px)] px-4">
      ...
      >
        <h2 className="text-2xl text-ink-900 dark:text-paper mb-5 text-center">Login</h2>
        ...
        <input
          ...
          required
          className="px-3.5 py-3 border border-[#D8D3C2] dark:border-white/20 border-b-2 border-b-[#B9B29A] dark:border-b-white/30 rounded-sm bg-[#FFFEF9] dark:bg-ink-900 dark:text-paper text-sm focus:outline-none focus:border-b-seal mb-3"
        />
        <button
          type="submit"
          className="bg-seal text-ink-900 py-3.5 rounded-sm font-semibold text-sm hover:-translate-y-0.5 hover:shadow-[0_4px_14px_rgba(201,162,39,0.35)] transition-all mb-10"
        >
          Login
        </button>
        <p className="text-sm text-muted dark:text-paper/60 text-center">
          Don't have an account?{" "}
          <Link to="/register" className="text-ink-900 dark:text-paper font-semibold hover:underline">Register</Link>
        </p>
      </form>
    </div>
  );
